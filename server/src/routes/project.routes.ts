 ...
 *     description: Creates a project scoped to the SuperAdmin's organization. Supports both `projectName` (or `name`), `projectDescription` (or `description`), `projectStatus` (or `status`).
 *     tags:
 *       - Projects
 *     security:
 *       - bearerAuth: []
